 ...
 */
final class Version20260419133752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, amount NUMERIC(10, 2) NOT NULL, user_id INT NOT NULL, item_id INT NOT NULL, INDEX IDX_29D6873EA76ED395 (user_id), INDEX IDX_29D6873E126F525E (item_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
